...
import static com.jnape.palatable.lambda.optics.builtin.lenses.MaybeLens.unLiftA;
import static com.jnape.palatable.lambda.optics.builtin.lenses.MaybeLens.unLiftB;
...
public final class ListLens {
    ...
    public static <X> Lens.Simple<List<X>, X> elementAt(int index, X defaultValue) {
        return adapt(unLiftB(unLiftA(elementAt(index), defaultValue)));
    }
}
