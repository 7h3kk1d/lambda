...
/**
 * Lazily inject the provided separator value between each value in the supplied {@link Iterable}. An
 * {@link Iterable} with fewer than two elements is left untouched.
 *
